...
class PFLDInference(nn.Module):
    def __init__(self):
        ...
        self.avg_pool3 = nn.AvgPool2d(11)
        # self.fc = nn.Linear(1280, 14)
        self.fc_conv=nn.Conv2d(1280,14,1)
    ...
    def forward(self, x):  # x: 3, 112, 112
        ...
        multi_scale=multi_scale.view(multi_scale.size(0),multi_scale.size(1),1,1)
        landmarks = self.fc_conv(multi_scale)
