...
LastEditTime: 2023-11-28 19:03:46
...
model.load_state_dict(torch.load('weights/mobilevitxs_68.pth', map_location='cuda'))
...
transform = transforms.Compose([
    transforms.Resize((256, 256), interpolation=transforms.InterpolationMode.BICUBIC),  # ,interpolation=transforms.InterpolationMode.BICUBIC),
