...
Date: 2024-01-04 11:51:31
LastEditors: yufengyao yufegnyao1@gmail.com
LastEditTime: 2024-01-19 11:08:43
FilePath: \图像平整\train_448.py
...
import torchvision
import numpy as np
from loss_rle_224 import PFLDLoss
# from pfld import PFLDInference
from pfld_rle_224 import PFLDInference
...
if __name__ == '__main__':
    ...
    model = PFLDInference()
    model.load_state_dict(torch.load('weights/pfld_rle_224_43.pth', map_location='cuda')) #109
    model_name="pfld_rle_224"
    ...
    for epoch in range(0,2000):
        ...
        for img, label in tqdm(train_loader,leave=False):
            ...
            out = model(img)
            l2_loss,l3_loss,max_loss,type_loss,direction_loss = criterion(label, out)
            optimizer.zero_grad()
            l2_loss.backward()
            optimizer.step()
